...
public class CentralNotasUtils {
    ...
    public static boolean confirmarNota(BigDecimal nuNota) throws Exception {
        ...
        if (barramento.getLiberacoesSolicitadas().size() == 0 &&
            ...
            if (barramento.getLiberacoesSolicitadas().size() > 0) {
                ...
                toResult.append("Liberações solicitadas - \n");
                for (LiberacaoSolicitada e :
                        barramento.getLiberacoesSolicitadas()) {
                    toResult.append("Evento: ").append(e.getEvento()).append(e.getDescricao() != null ? " Descrição:  "
                            + e.getDescricao() + "\n" : "\n");
                    break;
                }
    ...
    public static void confirmarNota2(BigDecimal nuNota, boolean refazerFinanceiro) throws Exception {
